...
public class WeChatXmlUtil {
	...
	public static void main(String[] args) {
		WechatMsg msg = xmlToBean(
				"<xml><Content><![CDATA[您好！welcome to subscribe will's public ...]]></Content> <ToUserName><![CDATA[ToUserName]]></ToUserName> <FromUserName><![CDATA[FromUserName]]></FromUserName> <CreateTime><![CDATA[1404286867859]]></CreateTime>  <MsgType><![CDATA[text]]></MsgType>  </xml> ",
				WechatMsg.class);
